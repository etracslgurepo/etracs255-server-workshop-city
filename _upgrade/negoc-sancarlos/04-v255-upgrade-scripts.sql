...
alter table sys_rule modify noloop int not NULL default '1' ; 
...
create table z20221118_invalid_business_receivable
select r.* 
from business_receivable r 
...
; 
delete from business_receivable where objid in (
  select objid from z20221118_invalid_business_receivable 
)
;
...
alter table entityindividual modify middlename varchar(100) null; 
