set @dbname := 'etracs255_sancarlos';
...
alter table sys_rule add _ukey varchar(50)
;
...
UPDATE `itemaccount` SET org_objid='142', org_name='SAN CARLOS CITY', `parentid`='RPT_BASICINT_CURRENT' WHERE (`objid`='REVITEM217a91b:1409e6ae44e:-7faa');
UPDATE `itemaccount` SET org_objid='142', org_name='SAN CARLOS CITY', `parentid`='RPT_BASICINT_PREVIOUS' WHERE (`objid`='ITEMACCT2941b9a8:14cea479194:-7f6a');
UPDATE `itemaccount` SET org_objid='142', org_name='SAN CARLOS CITY', `parentid`='RPT_BASIC_ADVANCE' WHERE (`objid`='REVITEM217a91b:1409e6ae44e:-7f3a');
UPDATE `itemaccount` SET org_objid='142', org_name='SAN CARLOS CITY', `parentid`='RPT_BASIC_CURRENT' WHERE (`objid`='REVITEM217a91b:1409e6ae44e:-7fb4');
UPDATE `itemaccount` SET org_objid='142', org_name='SAN CARLOS CITY', `parentid`='RPT_BASIC_PREVIOUS' WHERE (`objid`='ITEMACCT2941b9a8:14cea479194:-7fab');
UPDATE `itemaccount` SET org_objid='142', org_name='SAN CARLOS CITY', `parentid`='RPT_SEFINT_CURRENT' WHERE (`objid`='REVITEM-1c2fcd63:140c2c7c557:-7f70');
UPDATE `itemaccount` SET org_objid='142', org_name='SAN CARLOS CITY', `parentid`='RPT_SEFINT_PREVIOUS' WHERE (`objid`='ITEMACCT2941b9a8:14cea479194:-7eab');
UPDATE `itemaccount` SET org_objid='142', org_name='SAN CARLOS CITY', `parentid`='RPT_SEF_ADVANCE' WHERE (`objid`='REVITEM-1c2fcd63:140c2c7c557:-7f7d');
UPDATE `itemaccount` SET org_objid='142', org_name='SAN CARLOS CITY', `parentid`='RPT_SEF_CURRENT' WHERE (`objid`='REVITEM-1c2fcd63:140c2c7c557:-7f81');
UPDATE `itemaccount` SET org_objid='142', org_name='SAN CARLOS CITY', `parentid`='RPT_SEF_PREVIOUS' WHERE (`objid`='ITEMACCT2941b9a8:14cea479194:-7efc');
